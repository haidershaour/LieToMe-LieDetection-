...
for thisTrial in trials:
    ...
    # Live pupil class for window 
    class_live_pupil1 = RoutineLivePupilSize()
    ...
    while continueRoutine:
        ...
        # Draw pupil feedback
        current_pupil_mean1 = class_live_pupil1.get_pupil_mean()
        current_pupil_mean = class_live_pupil.get_pupil_mean()
        
        circle_pupil_size_live1.radius = current_pupil_mean1 * scaling_val
    ...
    routine.set_win_stimulus(class_live_pupil, circle_pupil_size_live)
    routine.set_win2_stimulus(class_live_pupil1, circle_pupil_size_live1)
